# Contributing to stapel-attributes
...
```bash
git clone https://github.com/usestapel/stapel-attributes.git && cd stapel-attributes
...
- **No new hardcoded behavior.** Anything a host project might want to
  ...
  (`STAPEL_ATTRIBUTES` dict; see `conf.py`) — with a dotted-path
