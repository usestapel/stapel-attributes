...
_LAZY_EXPORTS = {
    ...
    "AUDIENCE_OWNER": ".visibility",
    "AUDIENCE_STAFF": ".visibility",
    "OWNER": ".visibility",
    "PUBLIC": ".visibility",
    "STAFF": ".visibility",
    "UnknownVisibility": ".visibility",
    "VISIBILITIES": ".visibility",
    "dao_visibility": ".visibility",
    "is_public": ".visibility",
    "is_visible_to": ".visibility",
    "normalize_audience": ".visibility",
    "normalize_visibility": ".visibility",
    "public_daos": ".visibility",
    "public_slugs": ".visibility",
    "redact_dao": ".visibility",
    "redact_daos": ".visibility",
    # axis roles
    "AXIS_ROLES": ".axis",
    "GENERATION": ".axis",
    "MAKE": ".axis",
    "MILEAGE": ".axis",
    "MODEL": ".axis",
    "UnknownAxisRole": ".axis",
    "YEAR": ".axis",
    "axis_role_of": ".axis",
    "by_axis_role": ".axis",
    "normalize_axis_role": ".axis",
    # source-level gate
    "assert_raw_access_confined": ".guard",
    "find_raw_access": ".guard",
    # conditional rules
    "Cond": ".rules",
    "Rule": ".rules",
    "RuleState": ".rules",
